...
--populareBD.sql--
-- ... (partea de DELETE si RESET IDENTITY ramane la fel) ...
...
-- 3. Populeaza tabelul Locatii (MODIFICAT: Punem 0 initial la NrBiciclete)
INSERT INTO Locatii (NumeLocatie, Strada, Numar, Sector, NrBiciclete) VALUES
('Piata Romana', 'Dorobanti', 50, 1, 0),
('Universitate', 'Elisabeta', 3, 3, 0),
('Herastrau', 'Nordului', 1, 1, 0),
('Obor', 'Colentina', 2, 2, 0),
('Tineretului', 'Tineretului', 10, 4, 0);

-- 4. Populeaza tabelul Biciclete (Aceasta inserare va determina numerele reale)
INSERT INTO Biciclete (LocatieID, cod, Stare, PretBicicleta) VALUES
(1, 'BC001', 'liber', 10.50), -- 1 bicicleta la Locatia 1
(2, 'BC002', 'liber', 10.50), -- 3 biciclete la Locatia 2
(2, 'BC003', 'liber', 11.00),
(2, 'BC004', 'liber', 11.00),
(3, 'BC005', 'liber', 10.50), -- 2 biciclete la Locatia 3
(3, 'BC006', 'liber', 10.50),
(4, 'BC007', 'inchiriat', 10.00), -- 1 bicicleta la Locatia 4
(5, 'BC008', 'liber', 10.50), -- 4 biciclete la Locatia 5
(5, 'BC009', 'liber', 10.50),
(5, 'BC010', 'liber', 10.50),
(5, 'BC011', 'liber', 10.50);

-- ... (Pasii 5, 6, 7 raman neschimbati) ...
-- 5. AccesoriiBiciclete...
INSERT INTO AccesoriiBiciclete (BicicletaID, AccesoriuID, Marca) VALUES
(1, 1, 'BrandX'), (1, 4, 'Lumina'), (3, 2, 'SafeRide'), (5, 4, NULL), (5, 5, 'Protekt'), (8, 6, 'Grip');
...
-- 8. ACTUALIZARE AUTOMATA: Calculeaza NrBiciclete corect
UPDATE Locatii
SET NrBiciclete = (
    SELECT COUNT(*)
    FROM Biciclete
    WHERE Biciclete.LocatieID = Locatii.LocatieID
);
